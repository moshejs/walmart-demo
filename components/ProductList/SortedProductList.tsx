    ...
    switch (filter) {
      ...
      case SortingTypes.PRICE_ASC:
        return products
          ...
          .sort(
            (a: Product, b: Product) =>
              Number(parsePrice(a.price)) - Number(parsePrice(b.price))
          )
      case SortingTypes.PRICE_DESC:
        return products
          ...
          .sort(
            (a: Product, b: Product) =>
              Number(parsePrice(b.price)) - Number(parsePrice(a.price))
          )
      case SortingTypes.TOP_RATED:
        return products
          ...
          .sort(
            (a: Product, b: Product) =>
              Number(b.type === 'TOP_RATED') - Number(a.type === 'TOP_RATED')
          )
      case SortingTypes.POPULAR:
        return products
          ...
          .sort(
            (a: Product, b: Product) =>
              Number(b.type === 'POPULAR') - Number(a.type === 'POPULAR')
          )
      default:
